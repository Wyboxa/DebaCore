...
namespace Debales.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260613204412_AddDocumentsAIGovernanceTenantId")]
    partial class AddDocumentsAIGovernanceTenantId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Debales.Domain.AI.AIActionApproval", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("AIActionProposalId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("AIActionProposalId");

                    b.ToTable("AIActionApprovals", (string)null);
                });

            modelBuilder.Entity("Debales.Domain.AI.AIActionProposal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("ProposedByModel")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("Debales.Domain.AI.AIExecutionLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Debales.Domain.AI.AIKnowledgeBase", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Debales.Domain.AI.AIRule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Debales.Domain.Documents.Document", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Debales.Domain.Documents.DocumentType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Debales.Domain.Suppliers.SupplierContact", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Debales.Domain.AI.AIActionApproval", b =>
                {
                    b.HasOne("Debales.Domain.AI.AIActionProposal", null)
                        .WithMany()
                        .HasForeignKey("AIActionProposalId")
            ...
            modelBuilder.Entity("Debales.Domain.Documents.Document", b =>
                {
                    b.HasOne("Debales.Domain.Documents.DocumentType", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Debales.Domain.Suppliers.SupplierContact", b =>
                {
                    b.HasOne("Debales.Domain.Suppliers.Supplier", null)
                        .WithMany()
                        .HasForeignKey("SupplierId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
