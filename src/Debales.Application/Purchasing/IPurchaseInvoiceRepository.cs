...
public interface IPurchaseInvoiceRepository : IRepository<PurchaseInvoice>
{
    ...
    Task<IReadOnlyList<PurchaseInvoice>> GetBySupplierForStatementAsync(Guid supplierId, DateOnly? from, DateOnly? to, CancellationToken cancellationToken = default);
}
